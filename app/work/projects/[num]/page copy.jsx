...
const ProjectPage = async ({ params, searchParams }) => {
    ...
    return (
        <div className="container mx-auto py-12">
            ...
            {num === "37" && (
                <div className="flex flex-row flex-wrap justify-center items-center gap-4 mt-2">
                    ...
                    {[1, 2, 3, 4, 5, 6].map((index) => (
                        <AnimatedContent key={index} className="relative w-full max-w-4xl h-auto rounded-lg overflow-hidden shadow-md shadow-accent-hover">
                            <Image
                                src={`/assets/work/7/tp/unicorn/${index}.png`} // Dynamically load images
                                alt={project.title}
                                width={1920} // Full width for large screens
                                height={1080} // Maintain aspect ratio
                                loading="lazy"
            ...
            {num === "38" && (
                <div className="flex flex-row flex-wrap justify-center items-center gap-4 mt-2">
                    ...
                    {[1, 2, 3, 4].map((index) => (
                        <AnimatedContent key={index} className="relative w-full max-w-4xl h-auto rounded-lg overflow-hidden shadow-md shadow-accent-hover">
                            <Image
                                src={`/assets/work/9/devoirs/ds32024/${index}.png`} // Dynamically load images
                                alt={project.title}
                                width={1920} // Full width for large screens
                                height={1080} // Maintain aspect ratio
                                loading="lazy"
            ...
            {/* Display all images for project 40 */}
            {num === "40" && (
                <div className="flex flex-row flex-wrap justify-center items-center gap-4 mt-2">
                    <Image src={project.image}
                        alt={project.title}
                    ...
                    {[1, 2, 3].map((index) => (
                        <AnimatedContent key={index} className="relative w-full max-w-4xl h-auto rounded-lg overflow-hidden shadow-md shadow-accent-hover">
                            <Image
                                src={`/assets/work/9/devoirs/ds22024/${index}.png`} // Dynamically load images
                                alt={project.title}
                                width={1920} // Full width for large screens
                                height={1080} // Maintain aspect ratio
                                loading="lazy"
            ...
            {/* Display all images for project 41 */}
            {num === "41" && (
                <div className="flex flex-row flex-wrap justify-center items-center gap-4 mt-2">
                    <Image src={project.image}
                        alt={project.title}
                    ...
                    {[1, 2, 3].map((index) => (
                        <AnimatedContent key={index} className="relative w-full max-w-4xl h-auto rounded-lg overflow-hidden shadow-md shadow-accent-hover">
                            <Image
                                src={`/assets/work/8/devoirs/ds22024/${index}.png`} // Dynamically load images
                                alt={project.title}
                                width={1920} // Full width for large screens
                                height={1080} // Maintain aspect ratio
                                loading="lazy"
            ...
            {num === "42" && (
                <div className="flex flex-row flex-wrap justify-center items-center gap-4 mt-2">
                    ...
                    {[1, 2, 3, 4].map((index) => (
                        <AnimatedContent key={index} className="relative w-full max-w-4xl h-auto rounded-lg overflow-hidden shadow-md shadow-accent-hover">
                            <Image
                                src={`/assets/work/9/devoirs/ds32023/${index}.png`} // Dynamically load images
                                alt={project.title}
                                width={1920} // Full width for large screens
                                height={1080} // Maintain aspect ratio
                                loading="lazy"
